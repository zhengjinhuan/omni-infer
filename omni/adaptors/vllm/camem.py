...
try:
    from omni_vllm_ascend import (  # type: ignore # noqa: F401
        init_module, python_create_and_map, python_unmap_and_release)
    lib_name = find_loaded_library("omni_vllm_ascend")
    camem_available = True
except ImportError as e:
    logger.warning(
        "Failed to import omni_vllm_ascend:%s. Sleep mode will be disabled. ", e)
    init_module = None
