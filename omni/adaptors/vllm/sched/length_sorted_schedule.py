...
class LengthSortedScheduler(Scheduler):
    """ A scheduler that sorts requests by their lengths and then schedules them.
    This scheduler is designed to reduce the TTFT."""
