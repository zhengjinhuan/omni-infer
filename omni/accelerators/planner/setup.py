...
class PathManager:
    def __init__(self):
        ...
        ascend_root = "/usr/local/Ascend/ascend-toolkit/latest/arm64-linux"
        ...
        self.sources = [
            ...
            "omni_planner/cpp/placement_optimizer_for_swap.cpp",
            "omni_planner/cpp/expert_swap_optimizer.cpp",
            ...
            "omni_planner/cpp/atomic_state.cpp",
            "omni_planner/cpp/distributed_ops.cpp"
        ]
...
setup(
    name='omni_planner',  # 包的名称
    version='0.5.19.a3.develop',  # 包的版本
    description='Package for optimizing MoE layer',  # 包的简短描述
    author='TheoryLab/DataScienceTeam',  # 作者姓名
