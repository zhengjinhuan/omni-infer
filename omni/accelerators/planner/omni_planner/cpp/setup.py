...
# os.environ['ASCEND_TOOLKIT_PATH'] = "/usr/local/Ascend/latest/aarch64-linux"
os.environ['ASCEND_TOOLKIT_PATH'] = "/usr/local/Ascend/ascend-toolkit/latest/arm64-linux"
