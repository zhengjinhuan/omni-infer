...
class TestTokenBalance(unittest.TestCase):
    def setUp(self):
        expert_placement = np.load('./tests/patterns/placement_pattern_3d_v3_naivebalance3_16devices_HE.npy').astype(np.int32)
        ...
        expert_mapping = ExpertMapping('../tests/patterns/placement_pattern_3d_v3_naivebalance3_16devices_HE.npy', device)
