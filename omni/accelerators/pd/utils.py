...
#  | ------------------------------- decode- -------------------------------------|
def get_p_start_rank_v1(p_tp_size, p_dp_size, d_tp_size, d_dp_size, d_node_num, cur_d_node, cur_d_rank):
    ...
    return ((cur_d_node + cur_d_rank * d_node_num) * link_rank_step) % p_rank_num

def get_p_start_rank_v2(p_tp_size, p_dp_size, d_tp_size, d_dp_size, d_node_num, cur_d_node, cur_d_rank):
