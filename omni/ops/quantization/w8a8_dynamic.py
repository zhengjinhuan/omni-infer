...
from omni.adaptors.vllm.distributed.parallel_state import get_ep_group
from omni.ops.fused_moe import select_experts
...
class AscendW8A8DynamicFusedMoEMethod:
    ...
    def __init__(self):
        ...
        if int(os.environ.get("VLLM_ENABLE_MC2", '0')) == 1:
            try:
