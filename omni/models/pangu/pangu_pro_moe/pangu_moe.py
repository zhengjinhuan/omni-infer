...
class PanguProMoEMergedColumnParallelLinear(LinearBase):
...
class PanguProMoERowParallelLinear(LinearBase):
...
class PanguProMoEMLP(nn.Module):
    ...
    def __init__(
        ...
        if not use_h2p():
            ...
            self.gate_up_proj = PanguProMoEMergedColumnParallelLinear(
                hidden_size,
                [intermediate_size] * 2,
                bias=False,
                quant_config=quant_config,
            ...
            self.down_proj = PanguProMoERowParallelLinear(
                intermediate_size,
                hidden_size,
                bias=False,
                quant_config=quant_config,
