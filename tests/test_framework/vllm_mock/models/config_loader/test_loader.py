...
class TestModelAdditionalConfig(unittest.TestCase):
    ...
    def test_basic_load_json_config(self):
        """测试基本配置加载功能"""
        from omni.models.config_loader.loader import model_extra_config, update_task_config
        ...
        self.assertEqual(config.task_config.decode_gear_list, [17])
    ...
    def test_default_config_when_no_json(self):
        ...
        self.assertEqual(config.operator_opt_config.control_accept_rate, -1)
        self.assertEqual(config.task_config.decode_gear_list, [16])
